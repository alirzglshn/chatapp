...
def create_groupchat(request):
    ...
    return render(request, 'nameh/create_groupchat.html', context)
...
def chatroom_edit_view(request, chatroom_name):
    ...
    return render(request, 'nameh/chatroom_edit.html', context)
...
def chatroom_delete_view(request, chatroom_name):
    ...
    return render(request, 'nameh/chatroom_delete.html', {'chat_group': chat_group})
